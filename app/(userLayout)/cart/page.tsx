...
import { CartItem, userGetCartItems } from "@/app/lib/api/users/cart";
...
function CartItemCard({
  ...
  return (
    <div className="flex items-center justify-between bg-white border border-black/10 rounded-md px-6 py-4 gap-4">
      ...
      {/* Delete */}
      <button
        className="cursor-pointer hover:bg-gray-100 size-9 rounded-md flex items-center justify-center"
