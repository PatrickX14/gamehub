...
export type PartyStatus = "Gathering" | "Booked" | "Full" | "In Progress" | "Completed";
    ...
    return (
        <button
            ...
            <div className="flex flex-col justify-center gap-1 px-4 py-3 flex-1 min-w-0">
                <p className="text-[#364049] font-bold text-base leading-tight">{gameName}</p>
                <p className="text-sm text-[#627384]">
                    Hosted by: <span className="text-[#364049] font-medium">{hostName}</span>
                </p>
