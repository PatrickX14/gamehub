...
import { BoardGameData, getBoardGames } from "@/app/lib/api/admin/boardgames";
    ...
    >
      ...
      >
        ...
        <form
          ...
          className="px-6 pb-6 flex flex-col gap-4 mt-2"
        >
          {/* Game select */}
          ...
          <div className="flex gap-3">
            <div className="flex flex-col gap-1 flex-1">
              <label className="text-xs font-medium text-[#627384]">
                Location
              </label>
              <select
                value={location}
